...
void Obstacle2DSimpleWorker::assemble_p_prime_solver(){
...
std::vector<double> Obstacle2DSimpleWorker::compute_p_prime(
...
std::vector<double> Obstacle2DSimpleWorker::compute_u_prime_outflow(const std::vector<double>& u_star) const{
	double qin = 0;
	double qout = 0;
	for (size_t j=0; j<_grid.ny(); ++j){
...
std::vector<double> Obstacle2DSimpleWorker::compute_u_prime(const std::vector<double>& p_prime, const std::vector<double>& u_prime_outflow){
...
std::vector<double> Obstacle2DSimpleWorker::compute_v_prime(const std::vector<double>& p_prime){
...
TEST_CASE("Obstacle 2D, SIMPLE algorithm", "[obstacle2-simple]"){
	std::cout << std::endl << "--- cfd_test [obstacle2-simple] --- " << std::endl;
